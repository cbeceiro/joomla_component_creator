...
$canOrder = $user->authorise ('core.edit.state', 'com_[com]');
$saveOrder = $listOrder == 'a.ordering';
if ($saveOrder){
  $saveOrderingUrl = 'index.php?option=com_[com]&task=[tables].saveOrderAjax&tmpl=component';
...
<form
	action="<?php echo JRoute::_('index.php?option=com_[com]&view=[tables]'); ?>"
			...
			<table class="table table-striped" id="[table]List">
				<thead>
				  ...
				  <th width="1%" class="hidden-phone"><input type="checkbox"
							...
							onclick="Joomla.checkAll(this)" /></th> [headers]
...
foreach ( $this->items as $i => $item ):
    ...
    $canCreate = $user->authorise ('core.create', 'com_[com]');
    $canEdit = $user->authorise ('core.edit', 'com_[com]');
    $canCheckin = $user->authorise ('core.manage', 'com_[com]');
    $canChange = $user->authorise ('core.edit.state', 'com_[com]');
    ?>
